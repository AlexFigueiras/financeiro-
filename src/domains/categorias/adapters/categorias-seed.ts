...
const REGRAS_PADRAO: Array<{ termo: string; categoria_chave: string }> = [
  ...
  { termo: 'escola', categoria_chave: 'educacao' },
  { termo: 'faculdade', categoria_chave: 'educacao' },
  { termo: 'mensalidade', categoria_chave: 'educacao' },
  { termo: 'curso', categoria_chave: 'educacao' },
  { termo: 'doacao', categoria_chave: 'doacao' },
  { termo: 'dizimo', categoria_chave: 'doacao' },
  { termo: 'oferta', categoria_chave: 'doacao' },
  { termo: 'hospital', categoria_chave: 'saude' },
  { termo: 'clinica', categoria_chave: 'saude' },
  { termo: 'plano de saude', categoria_chave: 'saude' },
  { termo: 'consulta', categoria_chave: 'saude' },
  { termo: 'academia', categoria_chave: 'saude' },
  { termo: 'youtube', categoria_chave: 'assinaturas' },
  { termo: 'amazon prime', categoria_chave: 'assinaturas' },
  { termo: 'disney', categoria_chave: 'assinaturas' },
  { termo: 'hbo', categoria_chave: 'assinaturas' },
  { termo: 'icloud', categoria_chave: 'assinaturas' },
  { termo: 'petshop', categoria_chave: 'pets' },
  { termo: 'pet shop', categoria_chave: 'pets' },
  { termo: 'veterinaria', categoria_chave: 'pets' },
  { termo: 'racao', categoria_chave: 'pets' },
  { termo: 'ipva', categoria_chave: 'impostos' },
  { termo: 'iptu', categoria_chave: 'impostos' },
  { termo: 'darf', categoria_chave: 'impostos' },
  { termo: 'tarifa bancaria', categoria_chave: 'impostos' },
  { termo: 'cvm', categoria_chave: 'investimentos' },
  { termo: 'corretora', categoria_chave: 'investimentos' },
  { termo: 'tesouro direto', categoria_chave: 'investimentos' },
  { termo: 'passagem', categoria_chave: 'viagem' },
  { termo: 'hospedagem', categoria_chave: 'viagem' },
  { termo: 'hotel', categoria_chave: 'viagem' },
  { termo: 'airbnb', categoria_chave: 'viagem' },
  { termo: 'salario', categoria_chave: 'salario' },
  { termo: 'pagamento pix recebido', categoria_chave: 'salario' },
];
