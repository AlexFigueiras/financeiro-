...
export interface ContasRepository {
  ...
  criar(tenantId: string, nome: string, tipo: TipoConta, saldo?: number): Promise<ContaBancaria | null>;
  ...
  atualizar(tenantId: string, contaId: number, nome: string, tipo: TipoConta, saldo?: number): Promise<ContaBancaria | null>;
