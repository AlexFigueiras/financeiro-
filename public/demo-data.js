...
(() => {
  ...
  const ITENS_MERCADO = [
    ...
    { nome_produto: 'DETERGENTE 500ML', quantidade: 3, preco_unitario: 2.99, valor_total: 8.97, categoria: 'limpeza' },
    { nome_produto: 'TOMATE KG', quantidade: 1.8, preco_unitario: 8.9, valor_total: 16.02, categoria: 'hortifruti' },
    { nome_produto: 'PAO FRANCES KG', quantidade: 0.62, preco_unitario: 18.9, valor_total: 11.72, categoria: 'padaria' },
    { nome_produto: 'SHAMPOO 350ML', quantidade: 1, preco_unitario: 18.48, valor_total: 18.48, categoria: 'higiene' },
    { nome_produto: 'PILHA AA C/4', quantidade: 1, preco_unitario: 36.0, valor_total: 36.0, categoria: 'outros' },
  ];
  const ITENS_FARMACIA = [
    { nome_produto: 'DIPIRONA 500MG 20CP', quantidade: 2, preco_unitario: 12.5, valor_total: 25.0, categoria: 'farmacia' },
    { nome_produto: 'VITAMINA C 1G 10CP', quantidade: 1, preco_unitario: 31.2, valor_total: 31.2, categoria: 'farmacia' },
    { nome_produto: 'PROTETOR SOLAR FPS50', quantidade: 1, preco_unitario: 30.0, valor_total: 30.0, categoria: 'higiene' },
  ];
  ...
  function categoriasApi() {
    ...
    const naoDetalhado = TRANSACOES
      .filter((t) => t.valor < 0 && !t.cupom_id)
      .reduce((s, t) => s - t.valor, 0);
    return { mes: mesAtual, categorias, gastosNaoDetalhados: Math.round(naoDetalhado * 100) / 100 };
  }
